...
def register():
    hash=contract.functions.registerAsset(account,name,ssn,dob,os.getenv("assetName"),os.getenv("assetVal"), os.getenv("zillow_url")).transact({'from':account,'gas':1000000})
